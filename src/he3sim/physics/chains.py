...
class BranchingChainGenerator:
    ...
    def _schedule_neutron(
        ...
        heapq.heappush(
            self._pending,
            (reaction_time_s, self._next_sequence, chain_id, generation),
        )
    ...
    def sample_with_lineage(
        ...
        while self._pending and self._pending[0][0] < stop_s:
            reaction_time_s, _, chain_id, generation = heapq.heappop(self._pending)
        ...
        return CorrelatedArrivalBatch(times, chains, generation_array)
